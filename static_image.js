...
async function testImageAndEstimatePoses() {
  ...
  'keypoints': [{'position': {'y': 23.181006220404594,
     'x': 262.72001195782315},
    'part': 'nose',
    'score': 2},
   {'position': {'y': 15.127211889120197, 'x': 254.66621762653875},
    'part': 'leftEye',
    'score': 2},
   {'position': {'y': 15.127211889120197, 'x': 270.77380628910754},
    'part': 'rightEye',
    'score': 2},
   {'position': {'y': 15.127211889120197, 'x': 252.95783701081174},
    'part': 'leftEar',
    'score': 2},
   {'position': {'y': 15.127211889120197, 'x': 272.4821869048345},
    'part': 'rightEar',
    'score': 2},
   {'position': {'y': 57.75796289538901, 'x': 239.6687075078336},
    'part': 'leftShoulder',
    'score': 2},
   {'position': {'y': 51.9951367828916, 'x': 294.4155555765588},
    'part': 'rightShoulder',
    'score': 2},
   {'position': {'y': 95.5765092586532, 'x': 228.1430552828388},
    'part': 'leftElbow',
    'score': 2},
   {'position': {'y': 86.57209345787601, 'x': 306.3013844335847},
    'part': 'rightElbow',
    'score': 2},
   {'position': {'y': 116.46675391645627, 'x': 210.49440031331548},
    'part': 'leftWrist',
    'score': 2},
   {'position': {'y': 102.41986526724385, 'x': 287.21202293593706},
    'part': 'rightWrist',
    'score': 2},
   {'position': {'y': 129.7932893016065, 'x': 250.8341831007973},
    'part': 'leftHip',
    'score': 2},
   {'position': {'y': 126.9118762453578, 'x': 288.6527294640614},
    'part': 'rightHip',
    'score': 2},
   {'position': {'y': 129.7932893016065, 'x': 250.8341831007973},
    'part': 'leftKnee',
    'score': 2},
   {'position': {'y': 181.65872431408312, 'x': 305.22085453749145},
    'part': 'rightKnee',
    'score': 2},
   {'position': {'y': 236.76574901483949, 'x': 233.18552813127405},
    'part': 'leftAnkle',
    'score': 2},
   {'position': {'y': 236.76574901483949, 'x': 327.91198235545},
    'part': 'rightAnkle',
    'score': 2}]}]
